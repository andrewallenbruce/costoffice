...
`search_datasets()` retrieves information on the 83 available data sets, separated by physician specialty. If you're searching for one specialty in particular, just supply the `specialty` argument:
